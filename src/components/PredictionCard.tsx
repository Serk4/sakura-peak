...
export default function PredictionCard({ lat, lon, locationName }: PredictionCardProps) {
  const { data: temps, isLoading, error } = useQuery({
      ...
      <div className="space-y-4 text-sm">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className={`font-medium capitalize ${prediction.confidence === 'high' ? 'text-green-600' : 'text-amber-600'}`}>
